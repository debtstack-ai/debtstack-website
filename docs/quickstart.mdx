...
API_KEY = "ds_xxxxx"
BASE_URL = "https://credible-ai-production.up.railway.app/v1"
...
const BASE_URL = "https://credible-ai-production.up.railway.app/v1";
...
curl -H "X-API-Key: $DEBTSTACK_API_KEY" \
  "https://credible-ai-production.up.railway.app/v1/bonds?seniority=senior_unsecured&min_ytm=8.0&has_pricing=true"
```
...
curl -H "X-API-Key: $DEBTSTACK_API_KEY" \
  "https://credible-ai-production.up.railway.app/v1/bonds/resolve?q=RIG%208%25%202027"

# Lookup by CUSIP
curl -H "X-API-Key: $DEBTSTACK_API_KEY" \
  "https://credible-ai-production.up.railway.app/v1/bonds/resolve?cusip=89157VAG8"
```
...
curl -H "X-API-Key: $DEBTSTACK_API_KEY" \
  "https://credible-ai-production.up.railway.app/v1/documents/search?q=event+of+default&ticker=RIG&section_type=indenture"
```
...
```bash
curl -X POST "https://credible-ai-production.up.railway.app/v1/entities/traverse" \
