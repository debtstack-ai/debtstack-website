...
<CardGroup cols={2}>
  <Card
    ...
    icon="database"
  >
    211 companies with debt instruments, covenants, guarantees, collateral, and keyword/semantic/hybrid search across indentures, credit agreements, and SEC filings
  </Card>
  <Card
    title="AI-Optimized"
    icon="robot"
