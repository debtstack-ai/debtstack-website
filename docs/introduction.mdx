...
**211 companies** covering S&P 100 and NASDAQ 100, with thousands of debt instruments, real-time bond pricing, and searchable SEC filing sections. Expanding to 500+ companies.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="database"
  >
    211 companies with debt instruments, covenants, guarantees, collateral, and full-text search across indentures, credit agreements, and SEC filings
  </Card>
  <Card
    title="AI-Optimized"
    icon="robot"
...
DebtStack offers 11 atomic API endpoints optimized for AI agents:
...
| Search Documents | `GET /v1/documents/search` | $0.15 | Full-text search SEC filings |
