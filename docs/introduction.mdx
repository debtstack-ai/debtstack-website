...
**457 companies** covering S&P 100, NASDAQ 100, and broader S&P 500, with 8,600+ debt instruments, credit ratings, CDS spreads, ETF fund flows, credit spread indices, real-time bond pricing, and searchable SEC filing sections.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="database"
  >
    457 companies with debt instruments, credit ratings, covenants, guarantees, collateral, and keyword/semantic/hybrid search across indentures, credit agreements, and SEC filings
  </Card>
  <Card
    title="AI-Optimized"
    icon="robot"
  ...
  <Card
    title="Credit Ratings & Spreads"
    icon="star"
  >
    S&P, Moody's, Fitch ratings (846 ratings across 367 companies) + CDS spread time series across 111 companies
  </Card>
  <Card
...
DebtStack offers 16 atomic API endpoints optimized for AI agents:
...
| ETF Fund Flows | `GET /v1/market/flows` | $0.05 | Credit market sentiment via ETF flows |
| Credit Spread Indices | `GET /v1/market/spreads` | $0.05 | ICE BofA OAS indices from FRED |
