...
<Warning>
  **Deprecated**: The `/v1/pricing` endpoint is deprecated. Use `/v1/bonds` with `has_pricing=true` and pricing fields instead. This endpoint will be removed in a future version.
</Warning>
