...
DebtStack provides 16 core primitives for corporate debt analysis:
...
| GET | `/v1/market/flows` | ETF fund flows for credit market sentiment | $0.05 |
| GET | `/v1/market/spreads` | ICE BofA credit spread indices from FRED | $0.05 |
...
|--------------|------|-----------|
| Simple | $0.05 | Companies, Bonds, Resolve, Financials, Collateral, Covenants, Ratings, Market/CDS, Market/Flows, Market/Spreads |
