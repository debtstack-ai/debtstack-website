...
|--------------|------|-----------|
| Simple | $0.05 | `/v1/companies`, `/v1/bonds`, `/v1/bonds/resolve`, `/v1/financials`, `/v1/collateral`, `/v1/covenants`, `/v1/ratings`, `/v1/market/cds`, `/v1/market/flows`, `/v1/market/spreads` |
